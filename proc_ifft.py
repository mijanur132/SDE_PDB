    ...
    for filename in os.listdir(input_directory):
        if filename.endswith(".npy"):
            ...
            #  print(f"Loaded {filename} with shape: {k_space_data.shape}")
                ...
                for i in range(320):
                    plt.imsave(os.path.join("/home/xrv/score-mri-palash/temp/all320/", f"{filename}_ifft_10th_slice_{i}.png"), np.abs(image_volume[i]), cmap='gray')
