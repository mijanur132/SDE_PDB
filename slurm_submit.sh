...
#job_id=$(sbatch --dependency=afterany:3039244  train_frontier.slurm | awk '{print $4}')
job_id=$(sbatch train_frontier.slurm  | awk '{print $4}')
...
do
    ...
    job_id=$(sbatch --dependency=afterany:$job_id train_frontier.slurm | awk '{print $4}')
